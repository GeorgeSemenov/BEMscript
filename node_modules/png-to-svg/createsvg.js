...
function func(sourcePath = './wordpress.png', RGBquality = 80, Alphaquality = 90){
	// const sourcePath = process.argv[2] || './wordpress.png'
	...
	Promise.all([
		...
		.then(([
			...
			const AlphaURL = `${sourcePath}${sourcePath}.a.jpg`
