...
let BEMStrings = [
  ...
  `__elementName`,
  `tag.blockName<variables>[arrName,arrItemName,elementName]`,
  `tag.blockName[arrName,arrItemName,elementName]`,
  `tag.blockName<variables>`,
  `tag.blockName`,
  `blockName<variables>[arrName,arrItemName,elementName]`,
  `blockName[arrName,arrItemName,elementName]`,
  `blockName<variables>`,
  `blockName`,
